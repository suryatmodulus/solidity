...
public:
	...
	void setSource(SourceUnitName sourceUnitID, SourceCode _source);

	/// Adds given source, imported as @p _path with filesystem path @p _fspath.
	void setSource(SourceUnitName _sourceUnitName, std::optional<boost::filesystem::path> _fspath, SourceCode _source);
